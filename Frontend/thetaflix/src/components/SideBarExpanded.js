    ...
    <div className={!isSideBarOpen && "hidden"}>
      ...
      <div className="sidebar2 border dark:border-none flex  flex-col w-[15rem]  h-full overflow-y-scroll overflow-x-hidden absolute top-0 left-0 bg-white z-20 dark:bg-zinc-900 dark:text-white">
        ...
        <div className="first-part flex pl-2 pr-6  pb-4 flex-col text-sm w-[15rem] ">
          ...
          <div className="pt-3 border-b border-zinc-200 w-full "></div>
          <div className="pt-4 pl-4 mb-2">
            <span className="text-base">More from THETAFLIX</span>
          </div>
          <div className="THETAFLIX-Premium py-2 px-4 flex items-center hover:bg-zinc-100 dark:hover:bg-zinc-700 w-full rounded-lg  cursor-pointer">
            <FaYoutube size="1.4rem" className="mb-1 mr-4" />
            <span>THETAFLIX Premium</span>
          </div>
          <div className="THETAFLIX-music py-2 px-4 flex items-center hover:bg-zinc-100 dark:hover:bg-zinc-700 w-full rounded-lg  cursor-pointer">
            <SiYoutubemusic size="1.4rem" className="mb-1 mr-4" />
            <span>THETAFLIX Music</span>
          </div>
          <div className="THETAFLIX-kids py-2 px-4 flex items-center hover:bg-zinc-100 dark:hover:bg-zinc-700 w-full rounded-lg  cursor-pointer">
            <TbMoodKid size="1.4rem" className="mb-1 mr-4" />
            <span>THETAFLIX kids</span>
          </div>
          <div className="THETAFLIX-TV py-2 px-4 flex items-center hover:bg-zinc-100 dark:hover:bg-zinc-700 w-full rounded-lg  cursor-pointer">
            <ImDisplay size="1.4rem" className="mb-1 mr-4" />
            <span>THETAFLIX TV</span>
          </div>
